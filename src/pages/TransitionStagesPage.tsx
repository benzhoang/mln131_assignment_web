    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-indigo-100 relative overflow-hidden">
            ...
            <div className="relative z-10 p-8 max-w-6xl mx-auto">
                    ...
                    <div className="relative">
                        ...
                        {stages.map((stage, index) => (
                            ...
                            >
                                ...
                                {/* Content Card */}
                                <div className="ml-8 flex-1 bg-white rounded-xl shadow-lg p-6Quá độ lên Chủ nghĩa Xã hội ở Việt Nam hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        {stage.keyPoints.map((point, pointIndex) => (
                                            <div key={pointIndex} className="flex items-start bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                                                <div className={`w-3 h-3 rounded-full bg-gradient-to-r ${stage.color} mr-3 mt-1 flex-shrink-0`}></div>
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-4">
                                        {selectedStage.keyPoints.map((point: string, index: number) => (
                                            <div key={index} className="flex items-start bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                                                <div className={`w-4 h-4 rounded-full bg-gradient-to-r ${selectedStage.color} mr-4 mt-1 flex-shrink-0`}></div>
                                                <span className="text-gray-700 font-medium">{point}</span>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                {selectedStage.id === 1 && (
                                    <div className="bg-blue-50 p-6 rounded-xl">
                                        ...
                                        <p className="text-blue-700">
                                            Sau khi giành được độc lập năm 1945, Việt Nam phải đối mặt với nhiều thách thức: 
                                            nền kinh tế bị tàn phá bởi chiến tranh, hệ thống tài chính chưa hoàn thiện, 
                                            và cần xây dựng cơ sở vật chất cho chế độ mới. Giai đoạn này diễn ra trong bối cảnh 
                                ...
                                {selectedStage.id === 3 && (
                                    <div className="bg-purple-50 p-6 rounded-xl">
                                        ...
                                        <p className="text-purple-700">
                                            Việc thống nhất hai miền với hai hệ thống kinh tế khác nhau tạo ra nhiều khó khăn. 
                                ...
                                {selectedStage.id === 4 && (
                                    <div className="bg-orange-50 p-6 rounded-xl">
                                        ...
                                        <p className="text-orange-700">
                                            Đổi mới đã đưa Việt Nam thoát khỏi khủng hoảng, đạt được tăng trưởng kinh tế cao (GDP tăng trưởng 6-7%/năm), 
                                            cải thiện đời sống nhân dân, và hội nhập sâu rộng vào nền kinh tế thế giới 
                                            trong khi vẫn giữ vững định hướng xã hội chủ nghĩa. Việt Nam trở thành nước có thu nhập trung bình.
                                        </p>
                                    </div>
                                )}
                            </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 mb-8 animate-fade-in-up" style={{ animationDelay: '1.6s' }}>
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-3xl font-bold text-gray-800 flex-1 mr-4">CQ3.4: Hãy khái quát các thành phần kinh tế của Việt Nam trước năm 1975; các thành phần kinh tế Việt Nam trước năm 1986 và các thành phần kinh tế của Việt Nam hiện nay để làm sáng tỏ thời kỳ quá độ về phương diện kinh tế tất yếu tồn tại nền kinh tế nhiều thành phần.</h2>
                        <button
                        ...
                        <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-xl p-6 border border-red-200">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-white p-4 rounded-lg">
                                    <h4 className="text-lg font-bold text-gray-800 mb-4">a) Miền Bắc (theo con đường XHCN)</h4>
                                ...
                                {/* Miền Nam */}
                                <div className="bg-white p-4 rounded-lg">
                                    <h4 className="text-lg font-bold text-gray-800 mb-4">b) Miền Nam (theo mô hình TBCN)</h4>
                                    <ul className="space-y-2 text-gray-700">
                                        <li className="flex items-start">
                                            <span className="text-red-500 mr-2 mt-1">•</span>
                        ...
                        <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl p-6 border border-orange-200">
                            ...
                            <div className="bg-yellow-100 p-4 rounded-lg border-l-4 border-yellow-400">
                                <p className="text-orange-800 font-medium">
                                    <strong>🔹 Đặc điểm nổi bật:</strong> Mô hình tập trung quan liêu bao cấp, chỉ coi trọng quốc doanh và tập thể. 
                                    Tuy nhiên hiệu quả thấp, sản xuất trì trệ, đời sống khó khăn → dẫn đến khủng hoảng kinh tế – xã hội vào giữa thập niên 80.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                            ...
                            <div className="bg-white p-4 rounded-lg mb-4">
                                <p className="text-gray-700 mb-4">
                                    Sau Đại hội VI (1986), Đảng khởi xướng công cuộc Đổi mới, hình thành nền kinh tế thị trường định hướng XHCN với nhiều thành phần:
                                </p>
                            ...
                            <div className="bg-green-100 p-4 rounded-lg border-l-4 border-green-400">
                                <p className="text-green-800 font-medium">
                                    <strong>🔹 Đặc điểm nổi bật:</strong> Kinh tế nhiều thành phần vận hành theo cơ chế thị trường nhưng có sự quản lý của Nhà nước, 
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="bg-white p-4 rounded-lg">
                                    ...
                                    <p className="text-gray-700">
                                        Do trình độ lực lượng sản xuất, sự tồn tại nhiều hình thức sở hữu, và xu thế hội nhập quốc tế.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-lg">
                                    ...
                                    <p className="text-gray-700">
                                        Việc thừa nhận và phát triển kinh tế nhiều thành phần đã huy động được nhiều nguồn lực, 
                                        tạo động lực cho phát triển, góp phần giữ vững định hướng XHCN trong quá trình đổi mới.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                {/* Key Insights */}
                <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-8 border border-yellow-200 animate-fade-in-up" style={{ animationDelay: '1.8s' }}>
