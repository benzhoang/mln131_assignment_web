    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 p-8 max-w-6xl mx-auto">
                {/* Hero Section */}
                <div
                    className="bg-white from-primary-600 to-secondary-600 rounded-2xl p-8 text-black mb-8 shadow-2xl transform hover:scale-105 transition-all duration-300 animate-fade-in-up">
                    <h1 className="text-4xl font-bold mb-4">
                        Quá độ lên Chủ nghĩa Xã hội ở Việt Nam
                    </h1>
                    <p className="text-lg opacity-80 mb-6">
                        Website này cung cấp cái nhìn toàn diện về lý luận và thực tiễn quá độ lên CNXH ở Việt Nam, từ
                        các giai đoạn lịch sử đến những thành tựu hiện tại và triển vọng tương lai.
                    </p>
                ...
                {/* Importance Section */}
                <div
                    className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-8 mb-8 border border-yellow-200 animate-fade-in-up"
                ...
                {/* Key Concepts */}
                <div
                    className="bg-white rounded-xl shadow-lg p-8 mb-8 transform hover:scale-102 transition-all duration-300 hover:shadow-xl animate-fade-in-up"
                    style={{animationDelay: '0.5s'}}>
                    <h2 className="text-2xl font-bold mb-6 text-gray-800">Các khái niệm cốt lõi</h2>
                    <p className="text-gray-600 mb-6">
                        Những khái niệm cơ bản giúp hiểu rõ bản chất và đặc điểm của quá trình quá độ lên chủ nghĩa xã
                        hội ở Việt Nam.
                    </p>
                    <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm">
                                        Quá trình chuyển đổi từ xã hội cũ lên xã hội mới, từ chủ nghĩa tư bản lên chủ
                                        nghĩa xã hội.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <div
                            ...
                            <p className="text-blue-700 text-sm">
                                Phân tích các giai đoạn phát triển từ 1945 đến nay, rút ra quy luật và bài học kinh
                                nghiệm.
                            </p>
                        </div>
                        <div
                            className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-6 border border-green-200">
                        ...
                        <div
                            className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-6 border border-purple-200">
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            <div className="flex items-start space-x-3">
                                <span
                                    className="bg-blue-500 text-white px-2 py-1 rounded-full text-sm font-bold">LO1</span>
                                <div>
                                    <h4 className="font-semibold text-gray-800">Hiểu biết lý thuyết</h4>
                                    <p className="text-gray-600 text-sm">Nắm vững lý thuyết về quá độ lên CNXH và đặc
                                        trưng bản chất</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-3">
                                <span
                                    className="bg-green-500 text-white px-2 py-1 rounded-full text-sm font-bold">LO2</span>
                                <div>
                                    <h4 className="font-semibold text-gray-800">Phân tích thực tiễn</h4>
                                    <p className="text-gray-600 text-sm">Liên hệ lý thuyết với thực tiễn xây dựng CNXH ở
                                        Việt Nam</p>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-4">
                            <div className="flex items-start space-x-3">
                                <span
                                    className="bg-purple-500 text-white px-2 py-1 rounded-full text-sm font-bold">LO3</span>
                                <div>
                                    <h4 className="font-semibold text-gray-800">Tư duy phê phán</h4>
                                    <p className="text-gray-600 text-sm">Đánh giá thành tựu, thách thức và triển vọng
                                        phát triển</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-3">
                                <span
                                    className="bg-orange-500 text-white px-2 py-1 rounded-full text-sm font-bold">LO4</span>
                                <div>
                                    <h4 className="font-semibold text-gray-800">Ứng dụng công nghệ</h4>
                                    <p className="text-gray-600 text-sm">Sử dụng công nghệ để trình bày và tương tác
                                        hiệu quả</p>
                                </div>
                            </div>
                        </div>
