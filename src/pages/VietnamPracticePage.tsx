                    ...
                    <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8 border-l-4 border-green-400">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <button
                                ...
                                className="ml-4 p-2 rounded-lg hover:bg-green-100 transition-colors duration-200"
                            >
                                <svg 
                                    className={`w-6 h-6 text-green-600 transition-transform duration-200 ${expandedSections.practicalExamples ? 'rotate-180' : ''}`}
                                    fill="none" 
                                    stroke="currentColor" 
                                    viewBox="0 0 24 24"
                                >
